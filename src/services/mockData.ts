...
export const MOCK_PLANOS: PlanoAula[] = [
  {
    ...
    metodologiaAbertura: 'Roda de conversa sobre situações cotidianas que envolvem operações matemáticas.',
    metodologiaDesenvolvimento: 'Aula expositiva com material concreto (blocos lógicos). Jogos matemáticos em grupo. Atividade prática: mercadinho simulado.',
    metodologiaFechamento: 'Revisão com quiz interativo e avaliação individual escrita. Socialização das respostas.',
